...
public class DownLoadService extends Service {
     ...
     * 目标文件存储的文件名
     */
//    private String destFileName = SplashActivity.Apk_Name;
    ...
    private void loadFile() {
        ...
        retrofit.baseUrl(Constant.API_BASE_URL)
                .client(initOkHttpClient())
                .build()
                .create(IFileLoad.class)
                .loadFile()
                .enqueue(new FileCallback(destFileDir, MainActivity.Apk_Name) {
                    @Override
