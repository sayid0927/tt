...
public class HotsVarietyPresenter extends RxPresenter<HotsVarietyContract.View> implements HotsVarietyContract.Presenter<HotsVarietyContract.View> {
    ...
    @Inject
    public HotsVarietyPresenter(Api Api) {
        this.api = Api;
    }
