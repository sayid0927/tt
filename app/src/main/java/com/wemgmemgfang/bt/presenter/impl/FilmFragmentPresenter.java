...
public class FilmFragmentPresenter extends RxPresenter<FilmFragmentContract.View> implements FilmFragmentContract.Presenter<FilmFragmentContract.View> {
    ...
    @Inject
    public FilmFragmentPresenter(Api Api) {
        this.api = Api;
    }
