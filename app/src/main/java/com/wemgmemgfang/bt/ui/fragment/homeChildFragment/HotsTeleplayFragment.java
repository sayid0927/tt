...
import com.wemgmemgfang.bt.presenter.contract.HotsTeleplayContract;
import com.wemgmemgfang.bt.presenter.impl.HotsTeleplayPresenter;
...
public class HotsTeleplayFragment extends BaseFragment implements HotsTeleplayContract.View {

    @Inject
    HotsTeleplayPresenter mPresenter;
    ...
    public static HotsTeleplayFragment getInstance(List<HomeInfoBean.HotsInfoBean> data) {
