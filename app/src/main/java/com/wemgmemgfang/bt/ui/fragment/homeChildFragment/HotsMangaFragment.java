...
import com.wemgmemgfang.bt.presenter.contract.HotsMangaContract;
import com.wemgmemgfang.bt.presenter.impl.HotsMangaPresenter;
...
public class HotsMangaFragment extends BaseFragment implements HotsMangaContract.View {
    ...
    public static HotsMangaFragment getInstance(List<HomeInfoBean.HotsInfoBean> data) {
